...
namespace System.Buffers
{
    ...
    internal static class StringSearchValuesHelper
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static char TransformInput(char input) => CorelibCompat.ToUpperAsciiInvariant(input);
        ...
        public readonly struct CaseInsensitiveUnicode : ICaseSensitivity
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static bool Equals(ref char matchStart, string candidate) =>
                MemoryMarshal.CreateReadOnlySpan(ref matchStart, candidate.Length).Equals(candidate, StringComparison.OrdinalIgnoreCase);
        }
    }
}
