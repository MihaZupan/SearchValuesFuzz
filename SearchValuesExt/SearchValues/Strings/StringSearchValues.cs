...
namespace System.Buffers
{
    internal static class StringSearchValues
    {
        ...
        public static SearchValuesExt<string> Create(ReadOnlySpan<string> values, bool ignoreCase)
        {
            if (values.Length == 0)
            {
            ...
            {
                return new SingleStringSearchValuesFallback<SearchValuesExt.FalseConst>(string.Empty, uniqueValues);
            }
            ...
            SearchValuesExt<string> searchValues = CreateFromNormalizedValues(normalizedValues, uniqueValues, ignoreCase, ref ahoCorasickBuilder);
            ...
            static string NormalizeIfNeeded(string value, bool ignoreCase)
            {
                ...
                {
                    value = string.Create(value.Length, value, static (buffer, value) =>
                    {
                        CorelibCompat.ToUpperOrdinal(value, buffer);
                    });
                }
        ...
        private static SearchValuesExt<string> CreateFromNormalizedValues(
            ...
            ref AhoCorasickBuilder ahoCorasickBuilder)
        {
            ...
            static SearchValuesExt<string> PickAhoCorasickImplementation<TCaseSensitivity>(AhoCorasick ahoCorasick, HashSet<string> uniqueValues)
        ...
        private static SearchValuesExt<string>? TryGetTeddyAcceleratedValues(
            ReadOnlySpan<string> values,
            HashSet<string> uniqueValues,
            bool ignoreCase,
            bool allAscii,
        ...
        private static SearchValuesExt<string> PickTeddyImplementation<TStartCaseSensitivity, TCaseSensitivity>(
            ReadOnlySpan<string> values,
            HashSet<string> uniqueValues,
            int n)
        ...
        private static SearchValuesExt<string> CreateForSingleValue(
            string value,
            HashSet<string>? uniqueValues,
            bool ignoreCase,
            bool allAscii,
            bool asciiLettersOnly)
        {
            ...
            return ignoreCase
                ? new SingleStringSearchValuesFallback<SearchValuesExt.TrueConst>(value, uniqueValues)
                : new SingleStringSearchValuesFallback<SearchValuesExt.FalseConst>(value, uniqueValues);
        }
