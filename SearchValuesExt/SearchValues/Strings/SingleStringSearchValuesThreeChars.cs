...
namespace System.Buffers
{
    ...
    internal sealed class SingleStringSearchValuesThreeChars<TCaseSensitivity> : SearchValuesExt<string>
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        ShortInput:
            string value = _value;
            char valueHead = value.GetPinnableReference();
        ...
        private static Vector128<byte> GetComparisonResult(ref char searchSpace, nuint ch2ByteOffset, nuint ch3ByteOffset, Vector128<ushort> ch1, Vector128<ushort> ch2, Vector128<ushort> ch3)
        {
            ...
            {
                Vector128<ushort> cmpCh1 = Vector128.Equals(ch1, Vector128.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)));
            ...
            else
            {
                ...
                Vector128<ushort> cmpCh1 = Vector128.Equals(ch1, Vector128.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)) & caseConversion);
        ...
        private static Vector256<byte> GetComparisonResult(ref char searchSpace, nuint ch2ByteOffset, nuint ch3ByteOffset, Vector256<ushort> ch1, Vector256<ushort> ch2, Vector256<ushort> ch3)
        {
            ...
            if (typeof(TCaseSensitivity) == typeof(CaseSensitive))
            {
                Vector256<ushort> cmpCh1 = Vector256.Equals(ch1, Vector256.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)));
            ...
            else
            {
                ...
                Vector256<ushort> cmpCh1 = Vector256.Equals(ch1, Vector256.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)) & caseConversion);
        ...
        private static Vector512<byte> GetComparisonResult(ref char searchSpace, nuint ch2ByteOffset, nuint ch3ByteOffset, Vector512<ushort> ch1, Vector512<ushort> ch2, Vector512<ushort> ch3)
        {
            ...
            if (typeof(TCaseSensitivity) == typeof(CaseSensitive))
            {
                Vector512<ushort> cmpCh1 = Vector512.Equals(ch1, Vector512.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)));
            ...
            else
            {
                ...
                Vector512<ushort> cmpCh1 = Vector512.Equals(ch1, Vector512.LoadUnsafe(ref Unsafe.As<char, ushort>(ref searchSpace)) & caseConversion);
        ...
        private bool TryMatch(ref char searchSpaceStart, int searchSpaceLength, ref char searchSpace, uint mask, out int offsetFromStart)
        {
            ...
            do
            {
                ...
                mask = CorelibCompat.ResetLowestSetBit(CorelibCompat.ResetLowestSetBit(mask));
            }
            while (mask != 0);
