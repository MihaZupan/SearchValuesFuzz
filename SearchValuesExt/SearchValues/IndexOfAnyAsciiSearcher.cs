...
namespace System.Buffers
{
    internal static class IndexOfAnyAsciiSearcher
    {
        ...
        public static bool BitmapContains(ref Vector256<byte> bitmap, char c) =>
            c <= 127 &&
            (bitmap.GetElement(c & 0xF) & (1 << (c >> 4))) != 0;
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
            ...
            Vector128<byte> bitmap = bitmapRef.GetLower();
...
#pragma warning disable IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
        ...
        private static Vector128<byte> IndexOfAnyLookupCore(Vector128<byte> source, Vector128<byte> bitmapLookup)
        {
            ...
            Vector128<byte> bitMask = CorelibCompat.ShuffleUnsafe(bitmapLookup, lowNibbles);
            ...
            Vector128<byte> bitPositions = CorelibCompat.ShuffleUnsafe(Vector128.Create(0x8040201008040201, 0).AsByte(), highNibbles);
            ...
            where TNegator : struct, INegator
        {
            ...
            {
                result = CorelibCompat.FixUpPackedVector256Result(result);
            }
