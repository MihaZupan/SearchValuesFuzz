...
namespace System.Buffers
{
    ...
    public class SearchValuesExt<T> where T : IEquatable<T>?
    {
        // Only CoreLib can create derived types
        private protected SearchValuesExt() { }
        ...
        public virtual int IndexOfAnyMultiString(ReadOnlySpan<char> span) => throw new UnreachableException();
